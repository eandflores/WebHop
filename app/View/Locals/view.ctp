<h3><?php echo "Local ".$local['Local']['nombre']?></h3>
<?php 
  if(isset($local)){ ?>
    <ul class="view">
      <li>
      ...
      <li>
        ...
        <?php echo $local['Local']['votos_positivos'] ?>
      </li>
      <li>
        <span>Votos Negativos => </span>
        <?php echo $local['Local']['votos_negativos'] ?>
      </li>
      <li>
...
<a href="/Hop/Locals" class="Atras btn btn-danger">Atras</a>