<div class="margenIndex">
  <?php 
      ...
      if($local == "Todos" && $producto == "Todos" && $marca == "Todas"){ 
        ...
        $mensaje = "Listado Ofertas Local ".$loc['Local']['nombre']." Creados (".$fecha_inicio."/".$fecha_fin.")"; 
      } else if($producto == "Todos"){ 
        $mensaje = "Listado Ofertas Local ".$loc['Local']['nombre']." Marca ".$marca." Creados (".$fecha_inicio."/".$fecha_fin.")"; 
      } else if($local == "Todos"){ 
        $mensaje = "Listado Ofertas Producto ".$product['Producto']['nombre']." Marca ".$marca." Creados (".$fecha_inicio."/".$fecha_fin.")"; 
      } else if($marca == "Todas"){ 
        $mensaje = "Listado Ofertas Local ".$loc['Local']['nombre']." Producto ".$product['Producto']['nombre']." Creados (".$fecha_inicio."/".$fecha_fin.")"; 
      } else{ 
        $mensaje = "Listado Ofertas Local ".$loc['Local']['nombre']." Producto ".$product['Producto']['nombre']." Marca ".$marca." Creados (".$fecha_inicio."/".$fecha_fin.")"; 
      } 
  ?>
          ...
          if(isset($ofertas)){
            ...
            foreach ($ofertas as $index => $oferta) { ?>
              ...
              <?php 
                ...
                $elemento2 = array($oferta['Local']['nombre']." ".$oferta['Producto']['nombre'],$oferta['Oferta']['precio']);
